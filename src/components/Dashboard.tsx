...
import { TrendingUp, Users, Package, DollarSign, Activity, AlertTriangle, FileText, ArrowUp, ArrowDown, Crown, Building, Calendar, BarChart3, CreditCard, UserCheck, UserPlus } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ onTabChange }) => {
  ...
  const { productRevenue } = useProductRevenue(); 
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="card p-8">
        ...
        <div className="mb-8">
          <h4 className="text-xl font-bold text-charcoal mb-6">Product-wise Monthly Revenue</h4>
          <div className="bg-light-gray rounded-2xl p-6">
              ...
              {productRevenue.length > 0 ? (
                <div className="w-full h-full">
                  ...
                  <div className="flex flex-wrap gap-4 mb-6">
                    {appNames.map((appName, index) => (
                      <div key={appName} className="flex items-center">
                        ...
                        ></div>
                        <span className="text-sm font-medium text-charcoal">{appName}</span>
                      </div>
                    ))}
                  </div>
                    ...
                    <svg className="w-full h-full" viewBox="0 0 800 300">
                      ...
                      {appNames.map((appName, appIndex) => {
                        ...
                        const points = productRevenue.map((month, monthIndex) => {
                          ...
                          const y = 252 - ((revenue / maxRevenue) * 192);
                          return `${x},${y}`;
                        }).join(' ');
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-300">
                    ...
                    <div className="text-center">
                      <p className="text-xs text-charcoal-light">Best Performing Product</p>
                      <p className="font-semibold text-charcoal">
                    ...
                    <div className="text-center">
                      <p className="text-xs text-charcoal-light">Average Monthly Growth</p>
